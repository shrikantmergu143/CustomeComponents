     ...
     const ImageVideoFileCreateGroups = (msg) => {     
        ...
        return (
            <div className="imageUplodedGroupsWrap">            
                ...
                {(getExtension(msg?.file?.name) === "mp3" || getExtension(msg?.file?.name) === "aac" || getExtension(msg?.file?.name) === "m4a" || getExtension(msg?.file?.name) === "ogg" || getExtension(msg?.file?.name) === "wav" || getExtension(msg?.file?.name) === "mpeg") && (
