    ...
    return (<div className="medialinksfilesWrapper">
            ...
            <div className="medialinksfilesDetails">
                ...
                {FileandLinkMergeArray && FileandLinkMergeArray.slice(-4).reverse().map((msg, index) => {
                    ...
                    } else if( msg?.message_type === "file" &&msg?.file?.name?.includes("mp3") === true || msg?.file?.name?.includes("aac") === true ||msg?.file?.name?.includes("m4a") === true || msg?.file?.name?.includes("ogg") === true || msg?.file?.name?.includes("wav") === true || msg?.file?.name?.includes("mpeg") === true) { // audio condition
